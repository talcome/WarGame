...
TEST_CASE("3 VS 3") {
    WarGame::Board board(8,8);
    CHECK(!board.has_soldiers(1));
    board[{0,1}] = new WarGame::FootSoldier(1);//player 1 footSoldier1 {0,1}
   // CHECK_THROWS((board[{0,1}] = new FootSoldier(1))); //there is already soldier there
    ...
    board[{0,2}] = new WarGame::FootSoldier(1);//player 1 footSoldier2 {0,2}
	...
	board[{7,1}] = new WarGame::FootSoldier(2);//player 2 footSoldier1 {7,1}
    board[{7,2}] = new WarGame::FootSoldier(2);//player 2 footSoldier2 {7,2}
