...
WarGame::Board fillBoard(){
    WarGame::Board p(6,6);
    p[{0,0}]= new WarGame::FootSoldier(1);
    p[{3,3}]= new WarGame::FootSoldier(2);
    p[{5,0}]= new WarGame::FootCommander(1);
    p[{3,5}]= new WarGame::FootCommander(2);
    p[{0,1}]= new WarGame::Sniper(1);
    p[{3,0}]= new WarGame::Sniper(2);
    p[{2,1}]= new WarGame::SniperCommander(1);
    p[{0,3}]= new WarGame::SniperCommander(2);
    p[{5,1}]= new WarGame::Paramedic(1);
    p[{1,3}]= new WarGame::Paramedic(2);
    p[{4,5}]= new WarGame::ParamedicCommander(1);
    p[{4,0}]= new WarGame::ParamedicCommander(2);
    return p;
}
WarGame::Board fillCommBoard(){
    WarGame::Board p (5,5);
    p[{0,0}] = new WarGame::FootSoldier(1);
    p[{0,1}] = new WarGame::FootSoldier(2);
    p[{0,3}] = new WarGame::SniperCommander(2);
    p[{0,4}] = new WarGame::FootCommander(2);
    p[{2,0}] = new WarGame::Paramedic(2);
    p[{2,1}] = new WarGame::Paramedic(1);
    p[{2,2}] = new WarGame::FootCommander(1);
    p[{2,3}] = new WarGame::SniperCommander(1);
    p[{4,0}] = new WarGame::Sniper(1);
    p[{4,1}] = new WarGame::Sniper(2);
    p[{4,3}] = new WarGame::ParamedicCommander(1);
    p[{4,4}] = new WarGame::ParamedicCommander(2);
    return p;
}
...
TEST_CASE("Check Adding player to board"){
    ...
    WarGame::Board p = fillBoard();
            ...
            CHECK(typeid(*p[{0,0}]) == typeid(WarGame::FootSoldier));
            CHECK(typeid(*p[{3,3}]) == typeid(WarGame::FootSoldier));
            CHECK(typeid(*p[{5,0}]) == typeid(WarGame::FootCommander));
            CHECK(typeid(*p[{3,5}]) == typeid(WarGame::FootCommander));
            CHECK(typeid(*p[{0,1}]) == typeid(WarGame::Sniper));
            CHECK(typeid(*p[{3,0}]) == typeid(WarGame::Sniper));
            CHECK(typeid(*p[{2,1}]) == typeid(WarGame::SniperCommander));
            CHECK(typeid(*p[{0,3}]) == typeid(WarGame::SniperCommander));
            CHECK(typeid(*p[{5,1}]) == typeid(WarGame::Paramedic));
            CHECK(typeid(*p[{1,3}]) == typeid(WarGame::Paramedic));
            CHECK(typeid(*p[{4,5}]) == typeid(WarGame::ParamedicCommander));
            CHECK(typeid(*p[{4,0}]) == typeid(WarGame::ParamedicCommander));
}
...
TEST_CASE("Check Adding player to board 2"){
    ...
    WarGame::Board p = fillCommBoard();
            ...
            CHECK(p.has_soldiers(2));
            CHECK(typeid(*p[{0,0}]) == typeid(WarGame::FootSoldier));
            CHECK(typeid(*p[{0,1}]) == typeid(WarGame::FootSoldier));
            CHECK(typeid(*p[{0,3}]) == typeid(WarGame::SniperCommander));
            CHECK(typeid(*p[{0,4}]) == typeid(WarGame::FootCommander));
            CHECK(typeid(*p[{2,3}]) == typeid(WarGame::SniperCommander));
            CHECK(typeid(*p[{4,1}]) == typeid(WarGame::Sniper));
            CHECK(typeid(*p[{2,2}]) == typeid(WarGame::FootCommander));
            CHECK(typeid(*p[{2,3}]) == typeid(WarGame::SniperCommander));
            CHECK(typeid(*p[{2,0}]) == typeid(WarGame::Paramedic));
            CHECK(typeid(*p[{2,1}]) == typeid(WarGame::Paramedic));
            CHECK(typeid(*p[{4,3}]) == typeid(WarGame::ParamedicCommander));
            CHECK(typeid(*p[{4,4}]) == typeid(WarGame::ParamedicCommander));
            CHECK(typeid(*p[{4,0}]) == typeid(WarGame::Sniper));
}
...
TEST_CASE("Move function - no Commander"){
    ...
    p.move(1,{0,0},WarGame::Board::Up);
            CHECK(p[{0,0}]== nullptr);
            CHECK(typeid(*p[{1,0}])==typeid(WarGame::FootSoldier));

    p.move(1,{0,1},WarGame::Board::Right);
            CHECK(p[{0,1}]==nullptr);
            CHECK(typeid(*p[{0,2}])== typeid(WarGame::Sniper));
    ...
    p.move(2,{3,3},WarGame::Board::Up);
            CHECK(p[{3,3}]== nullptr);
            CHECK(typeid(*p[{4,3}])==typeid(WarGame::FootSoldier));

    p.move(2,{1,3},WarGame::Board::Right);
            CHECK(p[{1,3}]== nullptr);
            CHECK(typeid(*p[{1,4}])==typeid(WarGame::Paramedic));
...
TEST_CASE("Move Function - Commander"){
    ...
    p.move(1,{2,2},WarGame::Board::Up);
            CHECK(p[{2,2}]==nullptr);
            CHECK(typeid(*p[{3,2}])== typeid(WarGame::FootCommander));

    p.move(1,{2,3},WarGame::Board::Down);
            CHECK(p[{2,3}]==nullptr);
            CHECK(typeid(*p[{1,3}])==typeid(WarGame::SniperCommander));


    p.move(1,{4,3},WarGame::Board::Down);
            CHECK(p[{4,3}]==nullptr);
            CHECK(typeid(*p[{3,3}])==typeid(WarGame::ParamedicCommander));


    p.move(2,{0,4},WarGame::Board::Up);
            CHECK(p[{0,4}]==nullptr);
            CHECK(typeid(*p[{1,4}])== typeid(WarGame::FootCommander));

    p.move(2,{0,3},WarGame::Board::Left);
            CHECK(p[{0,3}]==nullptr);
            CHECK(typeid(*p[{0,2}])==typeid(WarGame::SniperCommander));


    p.move(2,{4,4},WarGame::Board::Down);
            CHECK(p[{4,4}]==nullptr);
            CHECK(typeid(*p[{3,4}])==typeid(WarGame::ParamedicCommander));
}
...
TEST_CASE("Extra"){
    ...
    b[{0,0}]= new WarGame::FootSoldier(1);
            CHECK(!b.has_soldiers(2));
            CHECK(b.has_soldiers(1));
    b[{3,3}] = new WarGame::Sniper(2);
            CHECK(b.has_soldiers(1));
            CHECK(b.has_soldiers(2));
